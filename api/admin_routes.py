...
async def get_settings(request: Request, admin=Depends(require_admin)):
    ...
    result = {
        ...
        "stripe_prices": {k: _mask_key(os.getenv(k, "")) for k in [
            "STRIPE_PRICE_T1_STARTER", "STRIPE_PRICE_T1_PRO", "STRIPE_PRICE_T1_GROWTH", "STRIPE_PRICE_T1_TEAM",
            "STRIPE_PRICE_T2_STARTER", "STRIPE_PRICE_T2_PRO", "STRIPE_PRICE_T2_GROWTH", "STRIPE_PRICE_T2_TEAM",
            "STRIPE_PRICE_T3_STARTER", "STRIPE_PRICE_T3_PRO", "STRIPE_PRICE_T3_GROWTH", "STRIPE_PRICE_T3_TEAM",
            "STRIPE_PRICE_T4_STARTER", "STRIPE_PRICE_T4_PRO", "STRIPE_PRICE_T4_GROWTH", "STRIPE_PRICE_T4_TEAM",
            "STRIPE_PRICE_T5_STARTER", "STRIPE_PRICE_T5_PRO", "STRIPE_PRICE_T5_GROWTH", "STRIPE_PRICE_T5_TEAM",
            "STRIPE_PRICE_T6_STARTER", "STRIPE_PRICE_T6_PRO", "STRIPE_PRICE_T6_GROWTH", "STRIPE_PRICE_T6_TEAM",
            "STRIPE_PRICE_BUNDLE_NANO", "STRIPE_PRICE_BUNDLE_STARTER_C", "STRIPE_PRICE_BUNDLE_PRO_C", "STRIPE_PRICE_BUNDLE_POWER_C",
        ]},
