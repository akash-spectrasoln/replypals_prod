...
const PAGE_TITLES = { dashboard: 'Dashboard', users: 'Users', licenses: 'Licenses', teams: 'Teams', analytics: 'Analytics', emails: 'Emails', logs: 'Logs', settings: 'Settings', security: 'Security' };
function navigate(page) {
    ...
    const render = { dashboard: renderDashboard, users: renderUsers, licenses: renderLicenses, teams: renderTeams, analytics: renderAnalytics, emails: renderEmails, logs: renderLogs, settings: renderSettings, security: renderSecurity };
